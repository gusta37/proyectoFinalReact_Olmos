        ...
        <div className="container-fluid">
          ...
          <div className="sobreN_container p-5">
            ...
            <div className="sobreN_text has-text-black is-size-5-desktop has-text-justified">
              <p>
                ¡Bienvenidos a Eco-Moda! Somos una marca comprometida con la
                moda consciente y amigable con el medio ambiente. Nuestra
              ...
              <br />
              <p>
                En Eco-Moda, celebramos la diversidad y creemos que todos somos
                hermosos a nuestra manera. Nuestro compromiso es impulsar la
                autoexpresión y la confianza a través de la moda sostenible.
              </p>
              <br />
              <p>
          ...
          <div className="equipo_container p-5">
            ...
            <div className="sobreN_D is-flex">
              <div className="">
                ...
                <p className="has-text-justified">
                  ...
                  único, se convierte en el cerebro detrás de nuestra empresa.
                  Su inteligencia y habilidades en la industria de la moda son
                  inigualables. Betty es el ingenio que impulsa la empresa,
                  aporta ideas frescas y lidera proyectos clave.
                </p>
              </div>
              <img
            ...
            <div className="sobreN_D is-flex">
              ...
              <div>
                ...
                <p className="has-text-justified">
                  Armando Mendoza es el presidente de Eco-Moda. Su principal rol
                  en la empresa es liderarla con carisma y encanto. Su liderazgo
                  es fundamental para el éxito de Eco-Moda.
                </p>
              </div>
            </div>
            <hr className="has-background-primary" />
            ...
            <div className="sobreN_D is-flex">
              <div>
                ...
                <p className="has-text-justified">
                  Marcela es la directora de publicidad de Eco-Moda y una modelo
                  de renombre. Su belleza es tan impresionante como su
                  profesionalismo. Marcela lidera las campañas publicitarias de
                  la empresa y agrega ese toque de sofisticación que distingue a
                  Eco-Moda en el mundo de la moda.
                </p>
              </div>
              <img
                className="equipo_img m-5"
            ...
            <div className="sobreN_D is-flex">
              ...
              <div>
                ...
                <p className="has-text-justified">
                  Hugo amigo de Armando y su asistente personal. Está siempre
                  dispuesto a ayudar en cualquier situación. Su papel en la
                  empresa es fundamental para mantener a Eco-Moda en
                  funcionamiento.
                </p>
              </div>
            </div>
            ...
            <div className="sobreN_D is-flex">
              <div>
                ...
                <p className="has-text-justified">
                  Nicolás es un periodista de moda con un ojo crítico y un don
                  para identificar tendencias. Su papel en Eco-Moda es esencial
                  para dar visibilidad a la marca en los medios de comunicación.
                </p>
              </div>
              <img
                className="equipo_img m-5"
            ...
            <div className="sobreN_D is-flex">
              ...
              <div>
                ...
                <p className="has-text-justified">
                  Es una modelo destacada en la empresa, con seis semestres de
                  economía en la San Marino.
                </p>
              </div>
            </div>
            <hr className="has-background-primary" />
          ...
          <p>
            <b className="thanks">Gracias por elegir Eco-Moda</b>
          </p>
        </div>
      )}
    </div>
